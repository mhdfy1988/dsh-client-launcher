...
- GitHub 仓库、package 名和自动更新源统一更名为 `dsh-client-launcher`；历史仓库链接由 GitHub 重定向，`DSH_DESKTOP_*` 环境变量和更新缓存标识保持兼容。
...
[Unreleased]: https://github.com/mhdfy1988/dsh-client-launcher/compare/v0.1.3...HEAD
[0.1.3]: https://github.com/mhdfy1988/dsh-client-launcher/compare/v0.1.2...v0.1.3
[0.1.2]: https://github.com/mhdfy1988/dsh-client-launcher/compare/v0.1.1...v0.1.2
[0.1.1]: https://github.com/mhdfy1988/dsh-client-launcher/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/mhdfy1988/dsh-client-launcher/releases/tag/v0.1.0
